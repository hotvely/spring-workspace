		...
		<form>
			<div class="form-group">
				<label for="title">제목</label><br /> <input type="text" name="title"
					id="title" class="form-control" readonly="readonly"
					value="${board.title }" />
			</div>
			<div class="form-group">
				<label for="content">내용</label>
				<textarea name="content" id="content" cols="30" rows="10"
					class="form-control" style="resize: none" readonly="readonly">
					${board.content }
				</textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="writer">작성자</label> <input type="text" id="writer"
					...
					readonly="readonly" /> <input type="hidden" name="no"
					value="${board.no}" />
			</div>
			<div class="button">
				<div class="update-delete-btn">
					<a class="btn btn-outline-warning"
						href="/board/update?no=${board.no }">수정</a> <a
						class="btn btn-outline-danger"
						href="/board/delete?no=${board.no }">삭제</a>
				</div>
				<div class="back-btn">
